...
function displayIsInClientInfo() {
    if (liff.isInClient()) {
        ...
        document.getElementById("isInClientMessage").textContent =
            "คุณกำลังเปิด LIFF Apps ใน Line Client";
    } else {
        document.getElementById("isInClientMessage").textContent =
    ...
    document
        ...
        .addEventListener("click", function () {
            if (!liff.isLoggedIn() && !liff.isInClient()) {
                ...
                document.getElementById("accessTokenField").textContent =
                    accessToken;
                toggleAccessToken();
            }
        });
                ...
                liff.shareTargetPicker([
                    ...
                    .then(
                        (document.getElementById(
                            "shareTargetPickerMessage",
                        ).textContent = "Share target picker was launched."),
                    )
                    .catch(function (res) {
                        document.getElementById(
                            "shareTargetPickerMessage",
                        ).textContent = "Failed to launch share target picker.";
                    });
            } else {
